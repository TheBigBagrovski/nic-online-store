...
public class OnlineStoreApplication implements WebMvcConfigurer {
    ...
    public ApplicationRunner dataLoader(CategoryRepository categoryRepo,
        ...
        return args -> {
            ...
            Image[] images = {
                    Image.builder().id(1L).path(productImagesPath + "/1/iphone13.jpg").build(),
                    Image.builder().id(2L).path(productImagesPath + "/1/iphone13-2.jpg").build(),
                    Image.builder().id(3L).path(productImagesPath + "/3/iphone14.jpg").build(),
                    Image.builder().id(4L).path(productImagesPath + "/4/iphone14pro.jpg").build(),
                    Image.builder().id(5L).path(productImagesPath + "/5/iphone14promax.jpg").build(),
                    Image.builder().id(6L).path(productImagesPath + "/5/iphone14promax-2.jpg").build(),
                    Image.builder().id(7L).path(productImagesPath + "/6/iphone11.jpg").build(),
                    Image.builder().id(8L).path(productImagesPath + "/6/iphone11-2.jpg").build(),
                    Image.builder().id(9L).path(productImagesPath + "/7/iphone11pro.jpg").build(),
                    Image.builder().id(10L).path(productImagesPath + "/7/iphone11pro-2.jpg").build(),
                    Image.builder().id(11L).path(productImagesPath + "/8/iphone12.jpg").build(),
                    Image.builder().id(12L).path(productImagesPath + "/8/iphone12-2.jpg").build(),
                    Image.builder().id(13L).path(productImagesPath + "/9/iphone12pro.jpg").build(),
                    Image.builder().id(14L).path(productImagesPath + "/9/iphone12pro-2.jpg").build(),
                    Image.builder().id(15L).path(productImagesPath + "/11/samsunggalaxys8.jpg").build(),
                    Image.builder().id(16L).path(productImagesPath + "/11/samsunggalaxys8-2.jpg").build(),
                    Image.builder().id(17L).path(productImagesPath + "/12/samsunggalaxya54.jpg").build(),
                    Image.builder().id(18L).path(productImagesPath + "/12/samsunggalaxya54-2.jpg").build(),
                    Image.builder().id(19L).path(productImagesPath + "/13/samsunggalaxyszflip4.jpg").build(),
                    Image.builder().id(20L).path(productImagesPath + "/14/samsunggalaxys23ultra.jpg").build(),
                    Image.builder().id(21L).path(productImagesPath + "/15/samsunggalaxys22ultra.jpg").build(),
                    Image.builder().id(22L).path(productImagesPath + "/16/opnordce2.jpg").build(),
                    Image.builder().id(23L).path(productImagesPath + "/16/opnordce2-2.jpg").build(),
                    Image.builder().id(24L).path(productImagesPath + "/17/huaweinova9.jpg").build(),
                    Image.builder().id(25L).path(productImagesPath + "/18/huaweip50.jpg").build(),
                    Image.builder().id(26L).path(productImagesPath + "/20/honor70.jpg").build(),
                    Image.builder().id(27L).path(productImagesPath + "/22/airpodspro.jpg").build(),
                    Image.builder().id(28L).path(productImagesPath + "/22/airpodspro-2.jpg").build(),
                    Image.builder().id(29L).path(productImagesPath + "/23/airpodspro2.jpg").build(),
                    Image.builder().id(30L).path(productImagesPath + "/23/airpodspro2-2.jpg").build(),
                    Image.builder().id(31L).path(productImagesPath + "/25/redmibuds3.jpg").build(),
                    Image.builder().id(32L).path(productImagesPath + "/28/Creative SXFI TRIO.jpg").build(),
                    Image.builder().id(33L).path(productImagesPath + "/29/Sennheiser CX 300S.jpg").build(),
                    Image.builder().id(34L).path(productImagesPath + "/32/Bluetooth-гарнитура Sony WI-C200.jpg").build(),
                    Image.builder().id(35L).path(productImagesPath + "/33/Bluetooth-гарнитура Sony WH-1000XM4.jpg").build(),
                    Image.builder().id(36L).path(productImagesPath + "/33/Bluetooth-гарнитура Sony WH-1000XM4-2.jpg").build(),
                    Image.builder().id(37L).path(productImagesPath + "/34/Bluetooth-гарнитура Sony WH-1000XM5.jpg").build(),
                    Image.builder().id(38L).path(productImagesPath + "/34/Bluetooth-гарнитура Sony WH-1000XM5-2.jpg").build(),
                    Image.builder().id(39L).path(productImagesPath + "/35/Bluetooth-гарнитура Sennheiser MOMENTUM Wireless M3AEBTXL.jpg").build(),
                    Image.builder().id(40L).path(productImagesPath + "/37/Bluetooth-гарнитура JBL Tune 115BT.jpg").build(),
                    Image.builder().id(41L).path(productImagesPath + "/41/Чехол-книжка DF для OPPO A17.jpg").build(),
                    Image.builder().id(42L).path(productImagesPath + "/42/Чехол-книжка DF для realme C35.jpg").build(),
                    Image.builder().id(43L).path(productImagesPath + "/48/Умная колонка Яндекс Станция 2.jpg").build(),
                    Image.builder().id(44L).path(productImagesPath + "/49/Умная колонка Яндекс Станция Макс.jpg").build(),
                    Image.builder().id(45L).path(productImagesPath + "/50/Умная колонка Яндекс Станция Мини с часами.jpg").build(),
                    Image.builder().id(46L).path(productImagesPath + "/54/Умная колонка VK Капсула.jpg").build(),
                    Image.builder().id(47L).path(productImagesPath + "/55/Умная колонка SberBoom.jpg").build(),
                    Image.builder().id(48L).path(productImagesPath + "/60/Колонки 2.1 SVEN MS-2050.jpg").build(),
                    Image.builder().id(49L).path(productImagesPath + "/62/Колонки 2.0 F&D T-70X.jpg").build(),
                    Image.builder().id(50L).path(productImagesPath + "/66/Стиральная машина Бирюса WM-ME610-04.jpg").build(),
                    Image.builder().id(51L).path(productImagesPath + "/68/Стиральная машина Beko WRS5512BWW.jpg").build(),
                    Image.builder().id(52L).path(productImagesPath + "/70/Пылесос DEXP H-1600.jpg").build(),
                    Image.builder().id(53L).path(productImagesPath + "/73/Пылесос Supra VCS-1410.jpg").build(),
                    Image.builder().id(54L).path(productImagesPath + "/76/Холодильник HIBERG RFS-480DX.jpg").build(),
                    Image.builder().id(55L).path(productImagesPath + "/76/Холодильник HIBERG RFS-480DX-2.jpg").build(),
                    Image.builder().id(56L).path(productImagesPath + "/77/Холодильник Tesler RCD-545I.jpg").build()
            };
